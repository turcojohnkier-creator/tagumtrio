  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50/60 text-slate-800">
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-4 py-8 sm:px-6 lg:px-8">
        <header className="flex items-center justify-between rounded-2xl border border-slate-200 bg-white/65 px-4 py-3 backdrop-blur sm:px-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs uppercase tracking-[0.28em] text-emerald-700">TriOPS</p>
        ...
        <main className="relative flex flex-1 items-center justify-center overflow-hidden py-12 sm:py-16">
          ...
          <section className="relative z-10 mx-auto w-full max-w-5xl px-2 text-center">
            ...
            <h1 className="mx-auto mt-6 max-w-4xl text-4xl font-semibold leading-tight text-slate-900 sm:text-6xl">
