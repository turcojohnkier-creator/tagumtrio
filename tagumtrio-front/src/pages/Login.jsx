...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50/60 px-4 py-10 sm:py-14">
      <div className="mx-auto w-full max-w-5xl overflow-hidden rounded-3xl border border-slate-200/90 bg-white/75 shadow-2xl shadow-black/30 backdrop-blur">
        <div className="grid lg:grid-cols-[1.05fr_0.95fr]">
          <section className="relative hidden lg:block">
            ...
            <div className="relative h-full p-10">
              <p className="text-xs uppercase tracking-[0.35em] text-emerald-700">TriOPS Workforce</p>
              <h1 className="mt-5 max-w-md text-4xl font-semibold leading-tight text-slate-900">Operations, attendance, and payroll in one production flow.</h1>
              ...
              <div className="mt-10 space-y-3 text-sm text-slate-800">
                <p className="rounded-2xl border border-slate-300/70 bg-white/70 px-4 py-3">Department routing and approvals</p>
                <p className="rounded-2xl border border-slate-300/70 bg-white/70 px-4 py-3">Live scan verification chain</p>
                <p className="rounded-2xl border border-slate-300/70 bg-white/70 px-4 py-3">Payroll and payslip visibility</p>
              </div>
            </div>
          </section>
          ...
          <section className="p-6 sm:p-8 md:p-10">
            ...
            <div className="mb-6">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-1">{t('login.welcome')}</h2>
