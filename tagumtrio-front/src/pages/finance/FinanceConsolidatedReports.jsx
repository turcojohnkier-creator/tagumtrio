...
export default function FinanceConsolidatedReports() {
    ...
    <div className="space-y-6">
      <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
          <div>
            <p className="text-xs uppercase tracking-[0.3em] text-slate-500">Finance consolidated</p>
            <h2 className="mt-2 text-2xl font-bold text-white">Consolidated payroll report cards</h2>
          ...
          <Link to="/app/payroll/reports" className="inline-flex items-center gap-2 rounded-xl border border-slate-800 bg-slate-950 px-4 py-2.5 text-sm text-slate-200 hover:border-slate-700">
          ...
          <div className="space-y-3">
            {reportCards.map((report) => (
              <button
                ...
                className={`group relative block w-full rounded-2xl border border-slate-800 bg-slate-950 p-4 text-left transition-all hover:border-cyan-500/30 hover:bg-slate-900 ${selectedReportId === report.id ? 'border-cyan-500/40 bg-cyan-500/10' : ''}`}
              >
