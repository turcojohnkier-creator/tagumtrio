  ...
  return (
    <div className="space-y-6">
      <div className="overflow-hidden rounded-3xl border border-slate-800 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 p-6 shadow-2xl shadow-black/20">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl space-y-2">
            ...
            <h2 className="text-3xl font-bold text-white">Payroll summary and consolidated totals</h2>
            <p className="text-sm leading-6 text-slate-400">Use this page for combined report review, salary totals, and detailed drilling into submitted report rows.</p>
          </div>
      ...
      <div className="flex justify-start">
        <Link to="/app/payroll/reports" className="inline-flex items-center gap-2 rounded-xl border border-slate-800 bg-slate-900 px-4 py-2.5 text-sm text-slate-200 hover:border-slate-700">
