...
function StatCard({ label, value, hint }) {
  return (
    <div className="rounded-lg border border-slate-200 bg-slate-50/80 p-4 shadow-lg shadow-black/10">
...
export default function FinanceHome() {
  ...
  return (
    <div className="space-y-6">
      <section className="overflow-hidden rounded-xl border border-slate-200 bg-gradient-to-br from-slate-50 via-white to-slate-50 p-6 shadow-sm">
        <div className="max-w-3xl space-y-3">
          ...
          <h1 className="text-xl font-semibold text-slate-900 sm:text-2xl">Finance now has its own clean workspace</h1>
