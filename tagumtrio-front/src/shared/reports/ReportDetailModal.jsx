          ...
          <div className="px-5 py-4 space-y-4">
            <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
              ...
              <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-4">
                ...
                <p className="mt-2 font-heading text-lg font-bold text-zinc-900">{firstEntry.product ? formatProductWithUnit(firstEntry.product, firstEntry.department || report.department) : '-'}</p>
              </div>
              <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-4">
      ...
      <AnimatePresence>
        {previewPhotos && (
          <div className="fixed inset-0 z-[90] overflow-y-auto p-4">
            ...
            <div className="relative flex min-h-full items-center justify-center">
            <motion.div
              className="relative z-10 max-h-[85vh] w-full max-w-4xl overflow-y-auto rounded-xl border border-zinc-200 bg-white shadow-sm"
              initial={{ opacity: 0, scale: 0.96, y: 12 }}
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.96, y: 12 }}
              transition={{ duration: 0.22, ease: 'easeOut' }}
            >
              <div className="sticky top-0 z-10 mb-4 flex items-center justify-between bg-white px-6 pt-6">
